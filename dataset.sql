CREATE TABLE dataset (
    `ID` INT,
    `Age` INT,
    `BusinessTravel` VARCHAR(17) CHARACTER SET utf8,
    `Department` VARCHAR(22) CHARACTER SET utf8,
    `DistanceFromHome` INT,
    `Education` INT,
    `EducationField` VARCHAR(16) CHARACTER SET utf8,
    `Gender` VARCHAR(6) CHARACTER SET utf8,
    `JobRole` VARCHAR(25) CHARACTER SET utf8,
    `JobSatisfaction` INT,
    `MaritalStatus` VARCHAR(8) CHARACTER SET utf8,
    `MonthlyIncome` INT,
    `NumCompaniesWorked` INT,
    `OverTime` VARCHAR(3) CHARACTER SET utf8,
...
(30,34,'Travel_Rarely','Research & Development',8,3,'Medical','Male','Laboratory Technician',3,'Married',4404,2,'No',12,3,1);
